...
namespace StudentManagementSystem.Controllers
{
    ...
    {
        private string _connectionString = @"Data Source=AHWRLMH2\SQLEXPRESS;Initial Catalog=School;Integrated Security=True;Connect Timeout=30;Encrypt=False;
        ...
        public ActionResult Add(Student student)
        {
            ...
            return RedirectToAction("Index"); //note: not returning a view since you are just posting info to the DB and probablyonly want to see the new list of students
